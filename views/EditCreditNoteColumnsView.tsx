...
const EditCreditNoteColumnsView = () => {
    ...
    const [columns, setColumns] = useState(() => {
        ...
        const defaultCols = [
            ...
            { id: 'Sales Invoice', label: 'Sales Invoice', visible: true },
            { id: 'Description', label: 'Description', visible: true },
            { id: 'Amount', label: 'Amount', visible: true },
            { id: 'Cost of Sales', label: 'Cost of Sales', visible: true },
        ...
        if (saved) {
            ...
            return defaultCols.map(col => ({
                ...col,
                visible: savedMap[col.id] !== undefined ? savedMap[col.id] : col.visible
            }));
        }
        return defaultCols;
    });
    ...
    const handleUpdate = () => {
        ...
        columns.forEach(col => {
            settings[col.id] = col.visible;
        });
        localStorage.setItem('credit_note_column_settings', JSON.stringify(settings));
        ...
        <div className="bg-slate-50 min-h-screen selection:bg-indigo-100 selection:text-indigo-900 font-sans p-8 md:p-12 animate-in fade-in duration-700">
            ...
            <div className="max-w-2xl mx-auto mb-10">
                <div className="flex items-center space-x-2 text-[10px] font-black text-indigo-500 uppercase tracking-[0.2em] mb-4">
                    <span className="cursor-pointer hover:text-indigo-600 transition-colors" onClick={() => navigate('/credit-notes')}>Credit Notes</span>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 font-medium text-sm">Select which data fields you want to see for Credit Notes.</p>
                    </div>
                </div>
            </div>
...
export default EditCreditNoteColumnsView;
