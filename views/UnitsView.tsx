        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 font-medium tracking-tight">Manage standard inventory counts, sizes, and packaging metrics</p>
            </div>
          </div>
        </div>
            ...
            <tbody className="divide-y divide-slate-50">
              {loading ? (
                ...
                <tr key={unit.id} className="hover:bg-slate-50/80 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <span className="text-sm text-slate-500 font-medium">{unit.description || '-'}</span>
                  </td>
                ...
                <tr>
                  <td colSpan={4} className="px-6 py-12 text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-sm font-bold text-slate-500">No units found</p>
                    </div>
                  </td>
                </tr>
              )}
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-300 border border-slate-200">
            <div className="bg-slate-50 p-6 border-b border-slate-100 flex items-center justify-between">
              <h2 className="text-xl font-black text-slate-900 tracking-tight">
                {editingUnit?.id ? 'Edit Unit of Measure' : 'New Unit of Measure'}
              </h2>
              <button 
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              ...
              <div className="space-y-1">
                ...
                <textarea 
                  ...
                  placeholder="e.g. Kilograms or Packaging boxes..."
                  rows={3}
